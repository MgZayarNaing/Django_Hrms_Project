...
def order_by(request):
    ...
    return render(request, 'contract_list.html', {'page_obj': contracts, 'order_selected': order_selected})
...
def all_contracts(request):
	...
	if request.method == "GET":
		...
		all_contracts = ContractModel.objects.all()
		paginator = Paginator(all_contracts, 10 ) # ! Show 2 contacts per page.
